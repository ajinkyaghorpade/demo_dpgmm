'''
 ...
 This code was used to demonstrate the Dirichlet Process Gaussian Mixture Model on a 2-D toy dataset.
 The DP GMM uses variational inference method as described in
...
# This method calculates the posterior probability of the given point under dpgmm.
...
estimators = [    ("Variational Inference in Infinite mixture with a Dirichlet process prior ",
